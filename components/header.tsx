  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${isScrolled || isMobileMenuOpen
        ...
        : "bg-card py-0 shadow-sm"
        }`}
    >
      {/* Top Bar */}
      <div className={`bg-neutral-900 text-white transition-all duration-300 overflow-hidden ${isScrolled || isMobileMenuOpen ? "h-0" : "h-10"}`}>
        <div className="container mx-auto px-4 lg:px-8 h-full flex items-center justify-between text-[13px] font-medium">
      ...
      <div className={`container mx-auto px-4 lg:px-8 transition-all duration-300 ${isScrolled || isMobileMenuOpen ? "py-3" : "py-5"}`}>
